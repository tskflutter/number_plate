...
class DepositRepo {
  ...
  Future<ResponseModel> insertDeposit({required String adsId, required String methodCode, required String currency, required bool isBoost}) async {
    String url = "${UrlContainer.baseUrl}${isBoost ? UrlContainer.paymentAdEndPoint : UrlContainer.depositEndPoint}/$adsId";
    Map<String, String> map = {"method_code": methodCode, "currency": currency};
