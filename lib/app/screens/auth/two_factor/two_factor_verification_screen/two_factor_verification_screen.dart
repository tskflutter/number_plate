                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(color: MyColor.getPrimaryColor().withValues(alpha: .075), shape: BoxShape.circle),
                        ...
                        Padding(
                          ...
                          child: PinCodeTextField(
                            ...
                            pinTheme: PinTheme(shape: PinCodeFieldShape.box, borderWidth: 1, borderRadius: BorderRadius.circular(5), fieldHeight: 40, fieldWidth: 40, inactiveColor: MyColor.getBorderColor(), inactiveFillColor: MyColor.getTransparentColor(), activeFillColor: MyColor.getTransparentColor(), activeColor: MyColor.getPrimaryColor(), selectedFillColor: MyColor.getTransparentColor(), selectedColor: MyColor.getPrimaryColor()),
