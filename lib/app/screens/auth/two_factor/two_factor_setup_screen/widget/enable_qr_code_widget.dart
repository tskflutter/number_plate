      ...
      children: [
        ...
        Padding(
          ...
          child: GestureDetector(
            ...
            child: Padding(
              ...
              child: DottedBorder(
                options: RoundedRectDottedBorderOptions(dashPattern: [10, 5], strokeWidth: 2, color: MyColor.getBorderColor(), radius: Radius.circular(Dimensions.mediumRadius)),
                child: Container(
        ...
        Center(
          child: Text.rich(
            TextSpan(
              children: [
                TextSpan(text: MyStrings.useQRCODETips2.tr, style: theme.textTheme.labelMedium?.copyWith(color: MyColor.getHeadingTextColor())),
                TextSpan(
