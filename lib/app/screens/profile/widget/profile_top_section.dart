      ...
      builder: (controller) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const CustomDivider(space: Dimensions.space15),
            Row(
              children: [CircleShapeImage(imageColor: MyColor.getPrimaryColor(), image: MyImages.country), const SizedBox(width: Dimensions.space15), CardColumn(header: MyStrings.country.tr, body: controller.model.data?.user?.countryCode ?? "")],
            ),
          ],
        ),
      ),
