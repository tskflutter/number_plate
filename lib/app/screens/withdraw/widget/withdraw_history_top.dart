  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<WithdrawHistoryController>(
      builder: (controller) => Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.defaultRadius), color: theme.cardColor, boxShadow: MyUtils.getBottomSheetShadow()),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(MyStrings.trxNo.tr, style: theme.textTheme.bodySmall?.copyWith(color: MyColor.getBodyTextColor(), fontWeight: FontWeight.w500)),
