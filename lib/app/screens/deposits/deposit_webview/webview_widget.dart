...
class MyWebViewWidget extends StatefulWidget {
  const MyWebViewWidget({super.key, required this.url, required this.boost});
        ...
        InAppWebView(
          ...
          onLoadStart: (controller, url) {
            ...
            if (url.toString() == '${UrlContainer.domainUrl}/user/deposit/history') {
              widget.boost ? Get.offAndToNamed(RouteHelper.promotionConfirmationScreen) : Get.offAndToNamed(RouteHelper.paymentConfirmationScreen);
