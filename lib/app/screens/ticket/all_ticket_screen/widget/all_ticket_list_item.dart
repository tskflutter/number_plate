...
class AllTicketListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: theme.cardColor, borderRadius: BorderRadius.circular(Dimensions.mediumRadius)),
      child: Column(
        children: [
          Row(
          ...
          Row(
            ...
            children: [
              ...
              Text(
                time,
                style: theme.textTheme.labelMedium?.copyWith(fontSize: Dimensions.fontSmall, fontStyle: FontStyle.italic, color: MyColor.getBodyTextColor()),
              ),
            ],
          )
        ],
