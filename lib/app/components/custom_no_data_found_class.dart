                  ...
                  child: Column(
                    children: [
                      Text(
                        ...
                        style: theme.textTheme.titleSmall?.copyWith(color: widget.isNoInternet ? MyColor.getErrorColor() : MyColor.getBodyTextColor(), fontSize: Dimensions.fontExtraLarge),
                      ),
                      const SizedBox(
                        height: 5,
                      ),
                      widget.isNoInternet
                          ...
                          : Text(
                              widget.message2,
                              style: theme.textTheme.labelMedium?.copyWith(color: MyColor.getBodyTextColor(), fontSize: Dimensions.fontLarge),
                              textAlign: TextAlign.center,
                            ),
                      widget.isNoInternet
                          ? const SizedBox(
                      ...
                      widget.isNoInternet
                          ? InkWell(
                              ...
                              child: RoundedBorderContainer(text: MyStrings.retry.tr, bgColor: MyColor.getErrorColor(), borderColor: MyColor.getErrorColor(), textColor: MyColor.white))
                          : const SizedBox()
                    ],
                  ),
                )),
