...
class LabelTextInstruction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return isRequired
        ? Row(
            children: [
              Text(text.tr, textAlign: textAlign, style: textStyle ?? regularDefault.copyWith(color: MyColor.headingTextColor)),
              const SizedBox(
                width: 2,
              ),
        ...
        : Row(
            children: [
              Text(
                text.tr,
                textAlign: textAlign,
                style: textStyle ?? regularDefault.copyWith(color: MyColor.headingTextColor),
              ),
              if (instructions != null) ...[
                Padding(
                  padding: const EdgeInsetsDirectional.only(start: Dimensions.space2, end: Dimensions.space10),
