...
//                             child: Text(
//                               widget.cityId ?? "",
//                               style: boldExtraLarge.copyWith(fontFamily: 'FE-FONT', color: MyColor.headingTextColor, fontSize: Dimensions.space32),
//                             ),
//                           ),
//                           Flexible(
//                             child: Text(
//                               "•",
//                               style: boldExtraLarge.copyWith(fontFamily: 'FE-FONT', color: MyColor.headingTextColor, fontSize: Dimensions.space22),
//                             ),
//                           ),
//                           Text(
//                             "${widget.letter} ${widget.number}ssssssssssssssssssssssssssss",
//                             style: boldExtraLarge.copyWith(fontFamily: 'FE-FONT', color: MyColor.headingTextColor, fontSize: Dimensions.space32),
//                           )
//                         ],
//                       )),
