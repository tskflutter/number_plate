...
class BottomSheetTopRow extends StatelessWidget {
  ...
  const BottomSheetTopRow({super.key, required this.header, this.bottomSpace = 10, this.bgColor = MyColor.lightBackground});
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text(header.tr, style: theme.textTheme.labelMedium?.copyWith(fontWeight: FontWeight.w600)),
