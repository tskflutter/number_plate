...
class CustomBottomSheet {
  ...
  CustomBottomSheet({required this.child, this.isNeedMargin = false, this.isNeedpadding = true, this.voidCallback, this.bgColor = MyColor.white});
        ...
        builder: (BuildContext context) => SingleChildScrollView(
              ...
              child: AnimatedPadding(
                ...
                child: Container(
                  ...
                  padding: isNeedpadding ? const EdgeInsets.symmetric(horizontal: Dimensions.space15, vertical: Dimensions.space12) : null,
