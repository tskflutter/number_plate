          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: MyColor.getBodyTextColor().withValues(alpha: 0.22), borderRadius: BorderRadius.circular(5)),
                alignment: Alignment.center,
                child: Text(widget.currency, textAlign: TextAlign.center, style: theme.textTheme.labelMedium?.copyWith(color: MyColor.getPrimaryColor(), fontWeight: FontWeight.w500)),
              ),
            ],
          ),
        ),
